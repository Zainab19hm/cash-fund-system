<x-app-layout title="الصرف حسب البند">
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('investor.expenses-by-category.print', request()->query()) }}"
               target="_blank"
        ...
        <form method="GET" action="{{ route('investor.expenses-by-category') }}" class="rounded-xl border border-bdr bg-surface p-4">
