<x-app-layout title="كشف الحركة لفترة">
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('investor.movement-statement.print', request()->query()) }}"
               target="_blank"
        ...
        <form method="GET" action="{{ route('investor.movement-statement') }}" class="rounded-xl border border-bdr bg-surface p-4">
