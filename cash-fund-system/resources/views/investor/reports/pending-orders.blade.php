<x-app-layout title="الأوامر المعلقة">
    <div class="space-y-6">
        <x-investor-nav />

        <div class="flex items-center justify-between">
            <div>
                <h1 class="font-heading text-2xl font-bold text-primary">الأوامر المعلقة</h1>
                <p class="mt-1 text-sm text-muted">طلبات بحالة PENDING</p>
            </div>
            <a href="{{ route('investor.pending-orders.print', request()->query()) }}"
               target="_blank"
