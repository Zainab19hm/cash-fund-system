<x-app-layout title="حالة أرشفة الوثائق">
    <div class="space-y-6">
        <x-admin-nav />

        <div class="flex items-center justify-between">
            <div>
                <h1 class="font-heading text-2xl font-bold text-primary">حالة أرشفة الوثائق</h1>
            </div>
            <a href="{{ route('admin.reports.documents-archive.print', request()->query()) }}"
               target="_blank"
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-bdr bg-bg/50">
                            ...
                            <th class="px-4 py-3 text-right font-semibold text-muted">عدد الوثائق</th>
