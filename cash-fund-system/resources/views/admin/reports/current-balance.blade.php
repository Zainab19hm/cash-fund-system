<x-app-layout title="الرصيد الحالي">
    <div class="space-y-6">
        <x-admin-nav />

        <div class="flex items-center justify-between">
            <div>
                <h1 class="font-heading text-2xl font-bold text-primary">الرصيد الحالي للصندوق</h1>
            </div>
            <a href="{{ route('admin.reports.current-balance.print', request()->query()) }}"
               target="_blank"
        ...
        <div class="rounded-xl border border-bdr bg-surface p-8 text-center">
            <div class="text-sm font-semibold text-muted mb-2">الرصيد الحالي</div>
