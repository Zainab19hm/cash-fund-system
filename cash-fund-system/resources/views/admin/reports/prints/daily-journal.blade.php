...
<head>
    <meta charset="utf-8">
    <title>يومية الصندوق — نظام إدارة الصندوق النقدي</title>
...
<body>
    ...
    <div class="page">
        ...
        <div class="filter-info">التاريخ: {{ $date }}</div>
            ...
            <tbody>
                @forelse($movements as $movement)
                    <tr>
                        ...
                        <td>{{ $movement->executed_at->format('Y-m-d H:i') }}</td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="7" style="text-align: center;">لا توجد حركات</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
