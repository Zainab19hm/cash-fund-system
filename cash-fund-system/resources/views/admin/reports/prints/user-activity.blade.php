...
<head>
    <meta charset="utf-8">
    <title>نشاط المستخدمين — نظام إدارة الصندوق النقدي</title>
...
<body>
    ...
    <div class="page">
        ...
        <div class="filter-info">
            @if(!empty($filters['user_id']) || !empty($filters['from']) || !empty($filters['to']))
        ...
        <table>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="7" style="text-align: center;">لا توجد أنشطة</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
